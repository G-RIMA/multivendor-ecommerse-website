      ...
      <div className="flex-1 overflow-y-auto">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mb-8">
            {[
              { title: 'Total Customers', value: '11,580', icon: <Users className="text-emerald-500" />, change: '+5.9%' },
              { title: 'Total Orders', value: '45,580', icon: <ShoppingCart className="text-blue-500" />, change: '+10.5%' },
              { title: 'Total Products', value: '8,580', icon: <Store className="text-purple-500" />, change: '-3.4%' },
